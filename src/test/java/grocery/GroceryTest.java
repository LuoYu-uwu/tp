...
class GroceryTest {
    ...
    public void printGrocery_noAmountNoExpiration_leaveEmpty() {
        Grocery grocery = new Grocery("apple", 0, 0, null, "fruit", 0,"Pantry");
        String message = "apple (fruit), amount not set, expiration date not set, cost not set, location: Pantry";
        assertEquals(message, grocery.printGrocery());
    }

    @Test
    public void printGrocery_costWrongFormat_formattedCost() {
        Grocery grocery = new Grocery("chicken", 1, 0, LocalDate.now().plusDays(1), "meat",1,"Pantry");
    ...
    public void printGrocery_correctAmtAndExpAndCost() {
        Grocery grocery = new Grocery("chicken", 1, 0, LocalDate.now().plusDays(1), "meat",1.20,"Pantry");
        String message = "chicken (meat)" + ", amount: 1 grams" + ", expiration: "
